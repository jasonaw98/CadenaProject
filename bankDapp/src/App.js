...
function App() {
  ...
  const [inputValue, setInputValue] = useState({ withdraw: "", deposit: "", bankName: "" , name: ""});
  ...
  const contractAddress = '0x022D0750AbaaDc94666aB3b6dE0C51A2B23d666c';
  ...
  const donateMoneyHandler = async (event) => {
    try {
      ...
      if (window.ethereum) {
        ...
        const txn = await bankContract.donate({ value: ethers.utils.parseEther(inputValue.donate) });
        console.log("Deposting money...");
        await txn.wait();
        console.log("Deposited money...done", txn.hash);
  ...
  return (
    <main className="main-container">
      ...
      <section className="customer-section px-10 pt-5 pb-10">
        ...
        <div className="mt-7 mb-9">
          <form className="form-style">
            ...
            <button
              ...
              onClick={deposityMoneyHandler}>Deposit Money In Rinkeby</button>
          </form>
        </div>
        ...
        <div className="mt-5">
          <p><span className="font-bold">Bank Owner Balance: </span>{customerTotalBalance}</p>
        </div>
        <div className="mt-5">
